...
Sample session can be found in [mama-jokes/Sounds/Jokes.mp3](https://github.com/per4mnce/area-code/tree/master/Sounds)
...
4. Name the Lambda Function "Area-Code".
...
## Examples
### One-shot model:
    User: "Alexa, ask Area Code to find 860"
    Alexa: "(reads back description for the area code)"